...
namespace Saga.HandleBuilder
{
    ...
    public class HandleProxyFactory
    {
        ...
        public static void RegiterAllHandle(Action<ErrorModel> errorHandle)
        {
        ...
        static BaseRequestDelegate CreateRequestDelegate(Type serviceType, string Topic, HandleType handleType, MethodInfo method, Action<ErrorModel> errorHandle)
        {
